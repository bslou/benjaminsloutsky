...
const TITLE = 'Benjamin Sloutsky | Software'
    ...
    return (
        <Flex backgroundColor = {'#fff'} direction={'column'} alignItems = {'center'} width = {'90vw'} marginLeft = {'5vw'}>
            ...
            <Flex position={'fixed'} backgroundColor = {'#fff'} direction={'row'} marginRight = {'10vw'} marginTop = {'2vw'} marginBottom = {'2vw'} alignItems = {'center'} justifyContent = {'right'} gap = {'2vw'} width = {'100%'}>
                ...
                <Link href="/Software" fontSize={'1.5vw'} fontWeight = {500} textDecoration = {'underline'}>Software</Link>
            ...
            <Flex marginTop={'7vh'} direction={'column'} width = {'70vw'} padding = {'4vw'}>
                <Text marginBottom={'1vh'} fontSize = {'2vw'} fontWeight = {700}>Software</Text>
                <Text>Helping innovate and revolutionize the world through software!</Text>
            </Flex>
            ...
            <Flex direction={'column'} marginTop = {'6.5vh'} marginBottom = {'6.5vh'}>
                ...
                <Flex direction={'row'} gap = {'1vw'}>
                    {CardFormat(require('./assets/tutorlion.png'), 'TutorLion', 'Teaches K-12 Children math in an exciting way by college students!', 'https://tutorlion.org')}
                    {CardFormat(require('./assets/glazey.png'), 'Glazey', 'Help underrepresented community college students find opportunities!', 'https://glazey.netlify.app')}
                    {CardFormat(require('./assets/apps.png'), 'Crators', 'Developed free mobile applications to help progress the world!', 'https://apps.apple.com/us/developer/anna-slutsky/id1548339302')}
                </Flex>
            </Flex>
